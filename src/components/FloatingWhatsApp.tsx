...
export default function FloatingWhatsApp() {
    ...
    return (
        <a
            ...
            className="fixed bottom-32 md:bottom-16 right-4 md:right-6 z-50 bg-[#25D366] text-white p-3.5 rounded-full shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300 flex items-center justify-center group"
